name: cis-hardening-windows2019
description: Applies a CIS Benchmark Level 1 starter control set to Windows Server 2019.
schemaVersion: "1.0"
        ...
        inputs:
          commands:
            - |
              ...
              # Same underlying settings as the Windows 2022 component; a few CIS control IDs
              # differ between the 2019 and 2022 benchmark documents even though the
              # registry/secedit/auditpol mechanics are identical.
              # Type: Registry | SecEdit | AuditPol | Service | LocalAccount
              $CisControls = @(
                  ...
                  @{ Id = "2.3.1.2"; Type = "LocalAccount"; Name = "Guest" }
                  ...
                  @{ Id = "18.9.46.1"; Type = "Registry"; Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Real-Time Protection"; Name = "DisableRealtimeMonitoring"; Value = 0 }
                  ...
                  @{ Id = "18.9.64.3.9.1"; Type = "Registry"; Path = "HKLM:\SYSTEM\CurrentControlSet\Control\Terminal Server\WinStations\RDP-Tcp"; Name = "UserAuthentication"; Value = 1 }
                  @{ Id = "18.9.64.3.11.1"; Type = "Registry"; Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services"; Name = "MaxIdleTime"; Value = 900000 }
              )
        ...
        inputs:
          commands:
            - |
              ...
              aws s3 cp C:\CIS-Controls.json "s3://${logs_bucket}/windows2019/build-controls-$ts.json"
      ...
      - name: UploadValidateTranscript
        ...
        inputs:
          commands:
            - |
              $ts = (Get-Date -AsUTC).ToString("yyyyMMddTHHmmssZ")
              aws s3 cp C:\CIS-Validation-Results.json "s3://${logs_bucket}/windows2019/validate-results-$ts.json"
